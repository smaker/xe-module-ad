...
/* module */
$lang->dashboard->module->make = '페이지 생성';
...
$lang->display = '표시';
	...
	$lang->ads->dashboard_icon = array(
		// 기본 설정
		'dispAdConfig' => 'xi-cog',
		// 광고 관리
		'dispAdManageList' => 'xi-list',
		// 공지 관리
		'dispAdNoticeList' => 'xi-lightbulb-o',
		// 페이지 관리
		'dispAdModuleList' => 'xi-library-books-o'
	);
	/* status */
	...
	$lang->module_instance = '페이지';

$lang->publisher = '게시자';
$lang->click_count = '클릭 수';
$lang->ad_code = '광고 코드';

$lang->cmd_delete_ad = '광고 삭제';